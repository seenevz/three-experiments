...
import { Mesh, Shader, ShaderMaterial } from "three";
...
material.onBeforeCompile = (shader: Shader) => {
  shader.uniforms.uTime = uTimeVal;
...
depthMaterial.onBeforeCompile = (shader: Shader) => {
  shader.uniforms.uTime = uTimeVal;
...
const tick = () => {
  ...
  //   moddedShader && (moddedShader.uniforms.uTime.value = elapsedTime);
  uTimeVal.value = elapsedTime;
  // Update controls
  controls.update();
